...
abstract class $CustomUserCopyWith<$Res> {
  ...
  $Res call({String email, String password, String name, String position});
}
...
class _$_CustomUser implements _CustomUser {
  ...
  @override
  String toString() {
    return 'CustomUser(email: $email, password: $password, name: $name, position: $position)';
  }
...
abstract class _CustomUser implements CustomUser {
  const factory _CustomUser(
      ...
      required String password,
      required String name,
      required String position}) = _$_CustomUser;
